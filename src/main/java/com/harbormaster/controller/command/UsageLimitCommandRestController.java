...
/**
 * <h2>UsageLimitCommandRestController as REST API</h2>
 * <p>
 * Implements Spring Controller command CQRS processing for entity UsageLimit.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
@CrossOrigin
@RestController
@RequestMapping("/UsageLimitCommand")
public class UsageLimitCommandRestController extends BaseSpringRestController {

	public UsageLimitCommandRestController( UsageLimitService service ) {
		this.service = service;
	}
	
    /**
     * Handles create a UsageLimit.
    ...
    public CompletableFuture<Void> delete( @RequestParam(required=true) UUID usageLimitId  ) {
    	CompletableFuture<Void> completableFuture = null;
...
//************************************************************************
    ...
    private static final Logger LOGGER = Logger.getLogger(UsageLimitCommandRestController.class.getName());
