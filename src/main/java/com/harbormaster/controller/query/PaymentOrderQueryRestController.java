...
/**
 * <h2>PaymentOrderQueryRestController as REST API</h2>
 * <p>
 * Implements Spring Controller query CQRS processing for entity PaymentOrder.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
public class PaymentOrderQueryRestController extends BaseSpringRestController {
     ...
     */    
    @GetMapping("/load")
    public PaymentOrder load( @RequestParam(required=true) UUID paymentOrderId ) {
    ...
    public List<PaymentOrder> loadAll() {                
    	...
    	try {
            ...
            LOGGER.log( Level.WARNING,  "failed to load all PaymentOrders ", exc );
        	return null;
        }
