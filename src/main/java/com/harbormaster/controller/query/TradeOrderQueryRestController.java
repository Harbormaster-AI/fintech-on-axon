...
/**
 * <h2>TradeOrderQueryRestController as REST API</h2>
 * <p>
 * Implements Spring Controller query CQRS processing for entity TradeOrder.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
public class TradeOrderQueryRestController extends BaseSpringRestController {
     ...
     */    
    @GetMapping("/load")
    public TradeOrder load( @RequestParam(required=true) UUID tradeOrderId ) {
    ...
    public List<TradeOrder> loadAll() {                
    	...
    	try {
            ...
            LOGGER.log( Level.WARNING,  "failed to load all TradeOrders ", exc );
        	return null;
        }
