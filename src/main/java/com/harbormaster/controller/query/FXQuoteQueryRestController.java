...
/**
 * <h2>FXQuoteQueryRestController as REST API</h2>
 * <p>
 * Implements Spring Controller query CQRS processing for entity FXQuote.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
public class FXQuoteQueryRestController extends BaseSpringRestController {
     ...
     */    
    @GetMapping("/load")
    public FXQuote load( @RequestParam(required=true) UUID fXQuoteId ) {
    	FXQuote entity = null;
