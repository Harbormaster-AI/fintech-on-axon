...
/**
 * <h2>InvoiceQueryRestController as REST API</h2>
 * <p>
 * Implements Spring Controller query CQRS processing for entity Invoice.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
public class InvoiceQueryRestController extends BaseSpringRestController {
     ...
     */    
    @GetMapping("/load")
    public Invoice load( @RequestParam(required=true) UUID invoiceId ) {
    	Invoice entity = null;
