...
/**
 * <h2>SecurityQueryRestController as REST API</h2>
 * <p>
 * Implements Spring Controller query CQRS processing for entity Security.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
public class SecurityQueryRestController extends BaseSpringRestController {
     ...
     */    
    @GetMapping("/load")
    public Security load( @RequestParam(required=true) UUID securityId ) {
