...
/**
 *
 * <h2>Terminal business service</h2>
 *
 * <p>
...
//************************************************************************
    ...
    public TerminalService()  {
		...
		validator			= applicationContext.getBean(TerminalValidator.class);
	}
	...
	*/
	public static TerminalService getTerminalInstance() {
    ...
    */
    ...
    /**
     * assign Merchant on Terminal
     * @param		command AssignMerchantToTerminalCommand	
     * @exception	ProcessingException
     */     
	public void assignMerchant( AssignMerchantToTerminalCommand command ) throws ProcessingException {
		...
		TerminalService parentDelegate = TerminalService.getTerminalInstance();			
     ...
     * @exception	ProcessingException
     */     
	public void unAssignMerchant( UnAssignMerchantFromTerminalCommand command ) throws ProcessingException {
		...
		try {
			...
			final String msg = "Failed to unassign Merchant on Terminal";
	...
	protected Terminal load( UUID id ) throws ProcessingException {
		terminal = TerminalService.getTerminalInstance().getTerminal( new TerminalFetchOneSummary(id) );	
		return terminal;
	}
